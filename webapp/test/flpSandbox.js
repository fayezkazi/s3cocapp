		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fkcocs3cocapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fkcocs3cocapp-display": {
								"semanticObject": "fkcocs3cocapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fk.coc.s3cocapp",
									"url": sap.ui.require.toUrl("fk/coc/s3cocapp")
								}
							}
						}
					}
